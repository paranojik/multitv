...
void avcodec_register_all(void)
{
    ...
    av_register_filter(&speex_preproc_filter);
    av_register_filter(&speex_aec_filter);
    ...
    register_avcodec(&speex_encoder);
    register_avcodec(&speex_decoder);
    register_avcodec(&g729a_encoder);
    register_avcodec(&g729a_decoder);
    register_avcodec(&g7231_encoder);
    register_avcodec(&g7231_decoder);
    register_avcodec(&g728_encoder);
    register_avcodec(&g728_decoder);
    register_avcodec(&g711alaw_encoder);
    register_avcodec(&g711alaw_decoder);
    register_avcodec(&g711ulaw_encoder);
    register_avcodec(&g711ulaw_decoder);
